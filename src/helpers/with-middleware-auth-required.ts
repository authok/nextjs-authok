 ...
 * ```js
 * // middleware.js
 * import { withMiddlewareAuthRequired } from '@authok/nextjs-authok/middleware';
 *
 ...
 * ```js
 * // middleware.js
 * import { withMiddlewareAuthRequired, getSession } from '@authok/nextjs-authok/middleware';
 *
