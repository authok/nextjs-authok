...
import { AuthorizationParameters, HandleLogin as BaseHandleLogin } from '../authok-session';
...
export interface AuthorizationParams extends Partial<AuthorizationParameters> {
   ...
   *         // Get the connection name from the Authok Dashboard
  ...
  /**
   * Provides a hint to Authok as to what flow should be displayed. The default behavior is to show a
