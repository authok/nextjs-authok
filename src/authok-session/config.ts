...
export interface Config {
  ...
  /**
   * Boolean value to enable Authok's logout feature.
   */
   ...
   *     audience: 'https://your-authok-api-identifier'
   *   }
   * }));
   * ```
   *
...
export interface LogoutOptions {
   ...
   *
   * @example pass the federated logout param per https://authok.cn/docs/authenticate/login/logout/log-users-out-of-idps
   *
   * ```js
