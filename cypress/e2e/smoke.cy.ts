const useAuthok = Cypress.env('USE_AUTHOK');
const EMAIL = useAuthok ? Cypress.env('USER_EMAIL') : 'test';
const PASSWORD = useAuthok ? Cypress.env('USER_PASSWORD') : 'test';
...
const login = useAuthok ? loginToAuthok : loginToNodeOidc;
