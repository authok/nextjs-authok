...
import { initAuthok } from '../../src/edge';
import { withoutApi } from '../fixtures/default-settings';
import { IdTokenClaims } from 'openid-client';
import { encryption as deriveKey } from '../../src/authok-session/utils/hkdf';
import { defaultConfig } from '../authok-session/fixtures/helpers';
...
const setup = async ({ url = 'http://example.com', config = withoutApi, user, middleware }: any = {}) => {
  const mw = initAuthok(config).withMiddlewareAuthRequired(middleware);
