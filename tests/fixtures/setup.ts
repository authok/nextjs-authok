...
import { jwks, makeIdToken } from '../authok-session/fixtures/cert';
import { start, stop } from './server';
import { encodeState } from '../../src/authok-session/utils/encoding';
import { post, toSignedCookieJar } from '../authok-session/fixtures/helpers';
...
export const setup = async (
  ...
  codeExchange(config, await makeIdToken({ iss: 'https://acme.authok.local/', ...idTokenClaims }));
